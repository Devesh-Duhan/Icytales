    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[linear-gradient(120deg,#EFD7EF,#F5F9FC,#F8EAE1,#EAF8F9)] px-4">
            <div className='text-center'>
                ...
                <p className='text-[20px] text-[#646464] max-w-185 w-full text-center pt-5.75'>Lorem ipsum dolor sit amet, consec tse tur adipiscing elit, sed do eiusmod tempor incididunt ut labore</p>
                 <Link href="/">
