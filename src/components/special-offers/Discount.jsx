...
const Discount = ({ productId }) => {
  const discountProducts = homeProducts.find(
    (item) => item.id === parseInt(productId),
  );
  const [mainImage, setMainImage] = useState(discountProducts ? discountProducts.image[0]:null);
              ...
              <SwiperSlide key={item.id}>
                <div className="bg-white p-2.75 rounded-xl shadow-md  mx-auto mt-12.5 max-lg:mt-9 max-md:mt-6">
                  ...
                  >
                    ...
                    {/* Wishlist Button */}
                    <div className="bg-white rounded-full w-10 h-10 flex items-center justify-center absolute top-2.5 left-2.5 shadow-sm z-20">
