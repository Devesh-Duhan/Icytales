  ...
  return (
    <div className="px-6 w-full max-w-[280px]">
      ...
      <div className="space-y-4">
        <h3 className=" text-[22px] mb-5 leading-6 berkshire">Categories</h3>
        {categories &&
          categories.map((cat) => (
            <div
              key={cat.name}
          ...
          ${category === cat.name ? "border-pink-500" : "border-gray-300"}`}
              >
                {category === cat.name && (
          ...
          <div key={item.id} className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex gap-2 text-sm">
                <span className="line-through text-gray-400">$8.80</span>
