  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[linear-gradient(120deg,#EFD7EF,#F5F9FC,#F8EAE1,#EAF8F9)] px-4">
            <div className='text-center'>
                <div className='flex justify-center'><Image src="/images/thankyou-image.png" alt='thank-you' width={166} height={165}/></div>
                <h2 className='text-[112px] text-[#212529] '>Thank You!</h2>
